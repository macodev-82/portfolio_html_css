...
(() => {
  ...
  const translations = {
    en: {
      ...
      'websites-hero-secondary': 'View Website Demos',
      ...
      'websites-demos-eyebrow': 'Selected website demos',
      'websites-demos-title': 'Explore website concepts built around real service-business needs.',
      'websites-demos-description': 'Each demo presents a distinct visual direction, responsive experience and clear path from first impression to contact.',
      'websites-demo-fictional': 'Fictional demo',
      'websites-demo-type': 'Service platform & architecture showcase',
      'websites-demo-description': 'A premium bilingual residential cleaning platform with a real-time quoting and booking engine, live service tracking and a before/after showcase — paired with an interactive enterprise architecture demo covering microservices, observability, security and CI/CD.',
      'websites-demo-tag-estimator': 'Interactive Estimator',
      'websites-demo-tag-dispatch': 'Live Dispatch',
      'websites-demo-tag-before-after': 'Before/After',
      'websites-demo-tag-bilingual': 'Bilingual ES/EN',
      'websites-demo-tag-responsive': 'Responsive',
      'websites-demo-tag-accessible': 'Accessible',
      'websites-demo-live': 'Live Demo Coming Soon',
      'websites-demo-similar': 'Request a Similar Project',
    ...
    es: {
      ...
      'websites-hero-secondary': 'Ver demos de sitios web',
      ...
      'websites-demos-eyebrow': 'Demos seleccionadas',
      'websites-demos-title': 'Explora conceptos de sitios web creados para necesidades reales de negocios de servicios.',
      'websites-demos-description': 'Cada demo presenta una dirección visual diferente, una experiencia responsive y un camino claro desde la primera impresión hasta el contacto.',
      'websites-demo-fictional': 'Demo ficticia',
      'websites-demo-type': 'Plataforma de servicio y vitrina de arquitectura',
      'websites-demo-description': 'Una plataforma bilingüe premium de reservas de limpieza residencial con motor de cotización y reserva en tiempo real, seguimiento en vivo del servicio y comparador antes/después — junto a una vitrina interactiva de arquitectura empresarial que cubre microservicios, observabilidad, seguridad y CI/CD.',
      'websites-demo-tag-estimator': 'Cotizador Interactivo',
      'websites-demo-tag-dispatch': 'Live Dispatch',
      'websites-demo-tag-before-after': 'Antes/Después',
      'websites-demo-tag-bilingual': 'Bilingüe ES/EN',
      'websites-demo-tag-responsive': 'Responsive',
      'websites-demo-tag-accessible': 'Accesible',
      'websites-demo-live': 'Demo en preparación',
      'websites-demo-similar': 'Solicitar un proyecto similar',
